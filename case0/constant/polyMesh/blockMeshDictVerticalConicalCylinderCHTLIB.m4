...
m4_define(intCyRB, 21.0)
m4_define(intCyRT, 21.0)
m4_define(intCyH, 100.0)


//dimensions of external cylinder
m4_define(extCyRB, 29)
m4_define(extCyRT, 29)
m4_define(extCyH, 100.0)
...
m4_define(extCy2RB, 31)
m4_define(extCy2RT, 31)
m4_define(extCy2H, 100.0)

m4_define(extCy2RN, 20)
m4_define(extCy2HN, 50)
...
(
  ...
  //-External cylinder2
    ...
    (    calc(extCy2RB*cos(rad(45.0)))    calc(-1*extCy2H/2)    calc(-1*extCy2RB*cos(rad(45.0)))    ) vlabel(extCy2B0)
    (    calc(extCy2RB*cos(rad(45.0)))    calc(-1*extCy2H/2)    calc(extCy2RB*cos(rad(45.0)))    ) vlabel(extCy2B1)
    (    calc(-1*extCy2RB*cos(rad(45.0)))    calc(-1*extCy2H/2)    calc(extCy2RB*cos(rad(45.0)))    ) vlabel(extCy2B2)
    (    calc(-1*extCy2RB*cos(rad(45.0)))    calc(-1*extCy2H/2)    calc(-1*extCy2RB*cos(rad(45.0)))    ) vlabel(extCy2B3)
    //-Top of external cylinder2
    (    calc(extCy2RT*cos(rad(45.0)))    calc(extCy2H/2)    calc(-1*extCy2RT*cos(rad(45.0)))    ) vlabel(extCy2T0)
    (    calc(extCy2RT*cos(rad(45.0)))    calc(extCy2H/2)    calc(extCy2RT*cos(rad(45.0)))    ) vlabel(extCy2T1)
    (    calc(-1*extCy2RT*cos(rad(45.0)))    calc(extCy2H/2)    calc(extCy2RT*cos(rad(45.0)))    ) vlabel(extCy2T2)
    (    calc(-1*extCy2RT*cos(rad(45.0)))    calc(extCy2H/2)    calc(-1*extCy2RT*cos(rad(45.0)))    ) vlabel(extCy2T3)
);

blocks
(
  //-Internal square
    hex (intSqB1 intSqB2 intSqT2 intSqT1 intSqB0 intSqB3 intSqT3 intSqT0) LIB (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)

  //-Internal cylinder
    hex (intSqB0 intSqB3 intSqT3 intSqT0 intCyB0 intCyB3 intCyT3 intCyT0) LIB (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB3 intSqB2 intSqT2 intSqT3 intCyB3 intCyB2 intCyT2 intCyT3) LIB (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB2 intSqB1 intSqT1 intSqT2 intCyB2 intCyB1 intCyT1 intCyT2) LIB (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB1 intSqB0 intSqT0 intSqT1 intCyB1 intCyB0 intCyT0 intCyT1) LIB (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
  ...
  //-External cylinder2
    hex (extCyB0 extCyB3 extCyT3 extCyT0 extCy2B0 extCy2B3 extCy2T3 extCy2T0) metalCover (extCy2RN extCy2HN extCy2RN) simpleGrading (1 1 1)
    hex (extCyB3 extCyB2 extCyT2 extCyT3 extCy2B3 extCy2B2 extCy2T2 extCy2T3) metalCover (extCy2RN extCy2HN extCy2RN) simpleGrading (1 1 1)
    hex (extCyB2 extCyB1 extCyT1 extCyT2 extCy2B2 extCy2B1 extCy2T1 extCy2T2) metalCover (extCy2RN extCy2HN extCy2RN) simpleGrading (1 1 1)
    hex (extCyB1 extCyB0 extCyT0 extCyT1 extCy2B1 extCy2B0 extCy2T0 extCy2T1) metalCover (extCy2RN extCy2HN extCy2RN) simpleGrading (1 1 1)
);
...
(
  ...
  //-External cylinder2
    arc extCy2B0 extCy2B1 (    extCy2RB    calc(-1*extCy2H/2)    0    )
    arc extCy2B1 extCy2B2 (    0    calc(-1*extCy2H/2)    extCy2RB    )
    arc extCy2B2 extCy2B3 (    calc(-1*extCy2RB)    calc(-1*extCy2H/2)    0    )
    arc extCy2B3 extCy2B0 (    0    calc(-1*extCy2H/2)    calc(-1*extCy2RB)    )
    //-Top of external cylinder
    arc extCy2T0 extCy2T1 (    extCy2RT    calc(extCy2H/2)    0    )
    arc extCy2T1 extCy2T2 (    0    calc(extCy2H/2)    extCy2RT    )
    arc extCy2T2 extCy2T3 (    calc(-1*extCy2RT)    calc(extCy2H/2)    0    )
    arc extCy2T3 extCy2T0 (    0    calc(extCy2H/2)    calc(-1*extCy2RT)    )
);
...
(
    bottom
    {
        ...
        (
          ...
          //-External cylinder2
            (extCyB0 extCy2B0 extCy2B1 extCyB1)
            (extCyB3 extCy2B3 extCy2B0 extCyB0)
            (extCyB2 extCy2B2 extCy2B3 extCyB3)
            (extCyB1 extCy2B1 extCy2B2 extCyB2)
        );
    }
    ...
    top
    {
        ...
        (
          ...
          //-External cylinder2
            (extCyT0 extCy2T0 extCy2T1 extCyT1)
            (extCyT3 extCy2T3 extCy2T0 extCyT0)
            (extCyT2 extCy2T2 extCy2T3 extCyT3)
            (extCyT1 extCy2T1 extCy2T2 extCyT2)
        );
    }
    ...
    outerWall
    {
        ...
        faces
        (
            (extCy2B1 extCy2B0 extCy2T0 extCy2T1)
            (extCy2B0 extCy2B3 extCy2T3 extCy2T0)
            (extCy2B3 extCy2B2 extCy2T2 extCy2T3)
            (extCy2B2 extCy2B1 extCy2T1 extCy2T2)
        );
    }
);
